    ...
    <nav class="fixed top-0 left-0 w-full z-50 bg-brand-darkest/80 backdrop-blur-md border-b border-brand-border/40">
        <div class="flex justify-between items-center px-8 py-4 w-full max-w-7xl mx-auto">
            <div class="flex items-center gap-2">
                ...
                <span class="text-2xl font-display font-black text-white tracking-tight uppercase">NOVA<span class="text-brand-accent text-glow">GYM</span></span>
            </div>
            
            <div class="hidden md:flex items-center gap-8">
                <a class="font-display font-bold text-sm text-brand-accent tracking-wide" href="#">INICIO</a>
                <a class="font-display font-bold text-sm text-slate-400 hover:text-white tracking-wide transition-colors" href="#servicios">MÓDULOS</a>
                <a class="font-display font-bold text-sm text-slate-400 hover:text-white tracking-wide transition-colors" href="#tecnologia">TECNOLOGÍA</a>
            </div>
            
            <div>
                @auth
                    <a href="{{ route('dashboard') }}" class="px-6 py-2.5 bg-gradient-to-r from-brand-accent to-cyan-600 text-brand-darkest font-display font-bold rounded-xl hover:scale-95 transition-all duration-200 inline-block shadow-[0_0_20px_rgba(0,240,255,0.3)] text-sm">
                        Panel de Control
                    </a>
                @else
                    <a href="{{ route('login') }}" class="px-6 py-2.5 bg-gradient-to-r from-brand-accent to-cyan-600 text-brand-darkest font-display font-bold rounded-xl hover:scale-95 transition-all duration-200 inline-block shadow-[0_0_20px_rgba(0,240,255,0.3)] text-sm">
                        Acceder al Sistema
                    </a>
                @endauth
            </div>
    ...
    <main class="relative pt-24 z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
                ...
                <div class="lg:col-span-7 space-y-6">
                    <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-brand-accent/10 border border-brand-accent/20 rounded-full">
                        ...
                        <span class="font-display text-[10px] font-black uppercase text-brand-accent tracking-widest">SISTEMA DE ALTO RENDIMIENTO</span>
                    </div>
                    
                    <h1 class="font-display text-5xl lg:text-7xl font-black text-white leading-none uppercase tracking-tight">
                    ...
                    <p class="text-base text-slate-400 leading-relaxed max-w-xl font-medium">
                        Gestión inteligente, planificaciones técnicas y analítica de datos para centros de fitness de alto rendimiento. Optimiza tu operativa, automatiza entrenamientos y lidera la industria tecnológica del deporte.
                    </p>
                    
                    <div class="flex flex-wrap gap-4 pt-4">
                        <a href="{{ route('register') }}" class="px-8 py-3.5 bg-gradient-to-r from-brand-accent to-cyan-600 text-brand-darkest font-display font-bold rounded-xl shadow-[0_0_20px_rgba(0,240,255,0.4)] hover:brightness-110 hover:scale-105 transition-all duration-200 text-sm">
                            Registrarse Gratis
                        </a>
                        <a href="#servicios" class="px-8 py-3.5 border border-slate-800 text-white font-display font-bold rounded-xl hover:bg-slate-900 transition-all text-sm">
                            Descubrir Módulos
                        </a>
                    </div>
                </div>
                    ...
                    <div class="relative rounded-2xl overflow-hidden neon-card p-2 aspect-square flex items-center justify-center shadow-2xl">
                        ...
                        <div class="absolute bottom-6 left-6 right-6 p-5 rounded-xl bg-brand-dark/85 border border-brand-accent/25 backdrop-blur-md shadow-2xl">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="font-display text-[9px] font-black text-brand-accent uppercase tracking-widest">Retención Atletas</p>
                                    <p class="font-display text-2xl font-black text-white uppercase mt-0.5">98% EFICACIA</p>
                                </div>
                                <span class="material-symbols-outlined text-brand-accent text-[36px] font-bold">trending_up</span>
                            </div>
                        </div>
                    </div>
        ...
        <section id="servicios" class="px-8 py-24 max-w-7xl mx-auto">
            <div class="text-center mb-16 space-y-3">
                ...
                <p class="text-sm text-slate-400 max-w-2xl mx-auto font-medium">
                    Módulos avanzados diseñados específicamente para la precisión técnica, fidelización y el crecimiento integral de atletas y negocios.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="neon-card p-8 rounded-2xl group flex flex-col justify-between">
                    <div>
                        ...
                        <p class="text-slate-400 text-sm leading-relaxed mb-6 font-medium">
                            Control absoluto del registro de clientes. Organiza datos, estados de membresías y realiza auditorías operativas ágiles de manera simplificada.
                        </p>
                    </div>
                ...
                <div class="neon-card p-8 rounded-2xl group flex flex-col justify-between">
                    <div>
                        <div class="w-12 h-12 rounded-xl bg-brand-accent/10 flex items-center justify-center mb-6 border border-brand-accent/20 group-hover:border-brand-accent/50 transition-colors shadow-lg shadow-brand-accent/5">
                            <span class="material-symbols-outlined text-brand-accent text-2xl font-black">fitness_center</span>
                        </div>
                        <h3 class="font-display text-xl font-bold text-white mb-3">Planificación de Rutinas</h3>
                        <p class="text-slate-400 text-sm leading-relaxed mb-6 font-medium">
                            Diseño estructurado de planes de entrenamiento de alta intensidad con niveles de dificultad y descripciones anatómicas minuciosamente detalladas.
                        </p>
                    </div>
                    <ul class="space-y-2.5 border-t border-slate-800/80 pt-4">
                        <li class="flex items-center gap-2 text-xs font-bold text-slate-300">
                ...
                <div class="neon-card p-8 rounded-2xl group flex flex-col justify-between">
                    <div>
                        <div class="w-12 h-12 rounded-xl bg-brand-accent/10 flex items-center justify-center mb-6 border border-brand-accent/20 group-hover:border-brand-accent/50 transition-colors shadow-lg shadow-brand-accent/5">
                            <span class="material-symbols-outlined text-brand-accent text-2xl font-black">monitoring</span>
                        </div>
                        <h3 class="font-display text-xl font-bold text-white mb-3">Analítica de Rendimiento</h3>
                        <p class="text-slate-400 text-sm leading-relaxed mb-6 font-medium">
                            Métricas operativas del negocio en tiempo real. Visualiza los registros históricos de socios mediante un gráfico lineal personalizado con Chart.js.
                        </p>
                    </div>
                    <ul class="space-y-2.5 border-t border-slate-800/80 pt-4">
                        <li class="flex items-center gap-2 text-xs font-bold text-slate-300">
        ...
        <section class="px-8 py-24 max-w-7xl mx-auto">
            <div class="neon-card p-12 lg:p-20 rounded-3xl relative overflow-hidden text-center border-2 border-brand-accent/25 shadow-2xl">
                ...
                <h2 class="font-display text-3xl lg:text-5xl font-black text-white mb-4 relative z-10 uppercase tracking-tight">¿LISTO PARA LIDERAR TU GIMNASIO?</h2>
                <p class="text-slate-400 text-base max-w-xl mx-auto relative z-10 font-medium mb-8">
                    Únete a los coaches y centros de entrenamiento que maximizan sus métricas operativas y rutinas diarias con NovaGym.
                </p>
                
                <div class="flex justify-center relative z-10">
                    <a href="{{ route('login') }}" class="px-10 py-4 bg-gradient-to-r from-brand-accent to-cyan-600 text-brand-darkest font-display font-bold rounded-xl shadow-[0_0_20px_rgba(0,240,255,0.4)] hover:brightness-110 hover:scale-105 transition-all duration-200 text-sm">
                        Empezar Ahora
                    </a>
                </div>
            </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center px-8 w-full max-w-7xl mx-auto gap-4">
            <div class="text-center md:text-left space-y-1.5">
                <div class="flex items-center gap-2 justify-center md:justify-start">
                    ...
                    <span class="font-display font-black text-white text-lg tracking-tight uppercase">NOVA<span class="text-brand-accent font-display">GYM</span></span>
                </div>
                <p class="text-slate-500 text-xs font-medium">© 2026 NovaGym Performance Systems. Todos los derechos reservados.</p>
            </div>
