...
@section('scripts')
<script>
    function downloadRoutinePDF(id, name, clientName, difficulty, description) {
        ...
        printWindow.document.write(`
            <html>
            <head>
                <title>Rutina NovaGym - ${name}</title>
                <style>
                    body {
            ...
            <body>
                <div class="header">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #64748b; text-transform: uppercase;">Ficha de Entrenamiento Oficial</div>
                </div>
                ...
                <table class="meta-table">
                    <tr>
                        ...
                        <td style="text-transform: capitalize;">${difficultyBadge}</td>
                    </tr>
                    <tr>
                        <td class="label">Fecha de Generación</td>
                        <td colspan="3">${new Date().toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}</td>
                    </tr>
                </table>
                ...
                <div class="footer">
                    © ${new Date().getFullYear()} NOVAGYM Systems. Diseñado para coaching deportivo de alto rendimiento.
                </div>
