...
<body class="bg-brand-darkest min-h-screen flex items-center justify-center p-6 relative">
    ...
    <div class="w-full max-w-[450px] z-10 space-y-6">
        ...
        <div class="neon-card p-8 rounded-2xl shadow-2xl border border-brand-border/60">
            ...
            <!-- Form Action (Simulated alert) -->
            <form onsubmit="event.preventDefault(); alert('Se ha simulado el envío de un enlace de restauración a tu bandeja de correo electrónico.');" class="space-y-4">
                <!-- Email Input -->
                <div>
                    ...
                    <input type="email" id="email" required placeholder="Ej. admin@novagym.com"
