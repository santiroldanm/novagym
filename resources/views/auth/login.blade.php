        ...
        <div class="neon-card p-8 rounded-2xl shadow-2xl border border-brand-border/60">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <a href="{{ route('password.request') }}" class="text-[10px] font-bold text-brand-accent hover:underline uppercase tracking-wide">¿Olvidaste tu contraseña?</a>
                    </div>
            ...
            <div class="mt-8 border-t border-slate-800/80 pt-4 text-center">
                <p class="text-xs text-slate-400 font-medium">
                    ...
                    <a href="{{ route('register') }}" class="text-brand-accent hover:underline font-bold font-display tracking-wide uppercase ml-1">Regístrate</a>
                </p>
            </div>
        </div>
